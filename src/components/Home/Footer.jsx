               ...
               <div className="row footer-container">
                  <div className="col-7 footer-flex-item">
                     <h6 className="coffeeshop-logo">
                        <img src={require('../../assets/coffee-1.png')} alt="logo" />
                        el-Coffee Shop
                     </h6>
                     ...
                     <img src={require('../../assets/sosmed/fb-img.png')} alt="facebook" />
                     <img src={require('../../assets/sosmed/twitter-img.png')} alt="twitter" />
                     <img src={require('../../assets/sosmed/ig-img.png')} alt="instagram" />
